...
class JobControllerTest extends WebTestCase {
	...
	public function getMostRecentProgrammingJob() {
		...
		$query = $em
				->createQuery(
						'SELECT j from IbwJobeetBundle:Job j LEFT JOIN j.category c WHERE c.slug = :slug AND j.expires_at > :date ORDER BY j.created_at DESC');
	...
	public function testIndex() {
		...
		$this
				->assertEquals(
						'Ibw\JobeetBundle\Controller\JobController::showAction',
						$client->getRequest()->attributes->get('_controller'));
		$this
