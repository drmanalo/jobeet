...
class JobController extends Controller {
	...
	public function createAction(Request $request) {
		...
		if ($form->isValid()) {
			...
			return $this
					->redirect(
							$this
									->generateUrl('ibw_job_show',
											array('id' => $entity->getId())));
		}

		return $this
				->render('IbwJobeetBundle:Job:new.html.twig',
						array('entity' => $entity,
	...
	public function showAction($id) {
		...
		return $this
				->render('IbwJobeetBundle:Job:show.html.twig',
						array('entity' => $entity,
	...
	public function editAction($id) {
		...
		return $this
				->render('IbwJobeetBundle:Job:edit.html.twig',
						array('entity' => $entity,
	...
	public function deleteAction(Request $request, $id) {
		...
		if ($form->isValid()) {
			...
			if (!$entity) {
				throw $this
						->createNotFoundException('Unable to find Job entity.');
			}
